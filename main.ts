namespace SpriteKind {
    export const Paimon = SpriteKind.create()
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Paimon, function (sprite, otherSprite) {
    ...
    scene.setBackgroundImage(img`
        ...
        `)
    npc.setPosition(50, 76)
    mySprite.setPosition(29, 101)
    pause(1000)
    npc.sayText("there are some dragon's follower here")
    pause(1000)
    npc.sayText("we have to go through here ")
    pause(1000)
    npc.sayText("to rescue the saint")
    pause(1000)
    npc.sayText("be careful")
    pause(1000)
    npc.sayText("don't hit by them")
    pause(1000)
    npc.sayText("or you will get hurt")
    pause(1000)
    npc.sayText("Once your life is empty")
    pause(1000)
    npc.sayText("you will Die!!!")
    pause(1000)
    npc.sayText("try not to hit by them")
    pause(1000)
    npc.sayText("and kill them all", 500, false)
...
statusbars.onZero(StatusBarKind.EnemyHealth, function (status) {
    ...
    saint.sayText("You did it!!!!!")
    pause(1000)
    saint.sayText("Let's back to the kingdom")
    effects.clearParticles(npc)
    pause(1000)
    music.stopAllSounds()
    scene.setBackgroundImage(img`
        ...
        `)
    pause(2000)
    music.play(music.createSong(hex``), music.PlaybackMode.UntilDone)
...
info.onScore(100, function () {
    ...
    Myboss = sprites.create(img`
        ...
        ........cccccccc........
        `, SpriteKind.Boss)
    Myboss.setScale(1, ScaleAnchor.Right)
    Myboss.setPosition(111, 59)
    statusbar = statusbars.create(100, 5, StatusBarKind.EnemyHealth)
    statusbar.attachToSprite(Myboss, 5, 0)
    statusbar.setColor(2, 15, 5)
    statusbar.setStatusBarFlag(StatusBarFlag.SmoothTransition, true)
    mySprite.setPosition(41, 79)
    effects.clearParticles(npc)
    game.showLongText("then they arrived at the dragon's palace", DialogLayout.Center)
    npc.setPosition(28, 65)
    saint = sprites.create(img`
        . . . . . f f 4 4 f f . . . . . 
        . . . . f 5 4 5 5 4 5 f . . . . 
        . . . f e 4 5 5 5 5 4 e f . . . 
        ...
        . . . . . f f b b f f . . . . . 
        `, SpriteKind.snt)
    saint.setPosition(41, 99)
    saint.sayText("How you reach this place")
    pause(2000)
    saint.sayText("the dragon is weak now")
    pause(2000)
    saint.sayText("I had use my magic to let him stunned")
    pause(2000)
    effects.clearParticles(saint)
    saint.sayText("Hurry Uppppp!")
    pause(2000)
    saint.sayText("Kill him since he is stunned right now", 2000, false)
    effects.clearParticles(saint)
    info.setScore(0)
})
// -set amination
...
sprites.onDestroyed(SpriteKind.Paimon, function (sprite) {
    ...
    game.showLongText("gain 100 score to win", DialogLayout.Bottom)
    music.play(music.createSong(hex``), music.PlaybackMode.LoopingInBackground)
    for (let index = 0; index < 10; index++) {
        ...
        myEnemy2 = sprites.createProjectileFromSide(img`
            ...
            ........................
            `, randint(90, -90), 0)
        myEnemy2.y = randint(0, 100)
        myEnemy2.follow(mySprite)
        myEnemy2.setKind(SpriteKind.enemy2)
        myEnemy2.setVelocity(-50, -50)
        animation.runImageAnimation(
        myEnemy2,
        [img`
            ........................
...
game.setDialogCursor(img`
    ...
    . . f f c c c c c c c c . . . . 
    `)
game.showLongText("Hi," + game.askForString("What is your name"), DialogLayout.Bottom)
...
npc = sprites.create(img`
    ...
    . . c c c c c c c c c f . . . . 
    `, SpriteKind.Paimon)
npc.sayText("Hi, I am Paimon")
pause(2000)
npc.sayText("Welcome to Albedo...")
pause(2000)
npc.sayText("This is a world with MAGIC!!!")
pause(2000)
npc.sayText("Long times ago,")
pause(2000)
npc.sayText("People lived in peace and harmony...")
pause(2000)
npc.sayText("but one day, the dragon came,")
pause(2000)
npc.sayText("he destroyed everything and kidnapped the saint,")
pause(2000)
npc.sayText("who give us magic and power!!")
pause(2000)
npc.sayText("The summoned BRAVE,")
pause(2000)
npc.sayText("Please help us to bring back the saint...")
pause(2000)
npc.sayText("TO SAVE THE WORLD!!!", 500, false)
pause(2000)
effects.clearParticles(mySprite)
game.splash("touch Paimon to continue")
